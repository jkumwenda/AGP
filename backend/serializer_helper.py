...
#
    ...
    def createSlots(self, startTime, endTime, intervalInMinutes, day, event):
        ...
        while(condition):   
            slot= Slot(fk_eventid=event, slot_time=str(startTimeObject.time())[0:5], day=day)
            slot.save()
    ...
    def saveSlots(self, event):
        ...
        data = SerializerHelper.extractData(self,event.start_date, event.end_date)
        ...
        for day in numberOfDaysList:
            ...
            SerializerHelper.createSlots(self,startTime, endTime, timeInterval, day, event)
