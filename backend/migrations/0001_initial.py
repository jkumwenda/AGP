# Generated by Django 2.2.7 on 2020-01-30 10:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pk_countryid', models.ForeignKey(db_column='pk_countryid', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.Country')),
            ],
            options={
                'db_table': 'course',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_eventid', models.ForeignKey(db_column='fk_eventid', on_delete=django.db.models.deletion.DO_NOTHING, related_name='slots', to='backend.Event')),
            ],
            options={
                'db_table': 'slot',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_coursetype_holeid', models.ForeignKey(db_column='fk_coursetype_holeid', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.CourseTypeHole')),
                ('fk_eventid', models.ForeignKey(db_column='fk_eventid', on_delete=django.db.models.deletion.DO_NOTHING, related_name='scores', to='backend.Event')),
                ('fk_profileid', models.ForeignKey(db_column='fk_profileid', on_delete=django.db.models.deletion.DO_NOTHING, related_name='scores', to='backend.Profile')),
            ],
            options={
                'db_table': 'score',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fk_profileid', models.ForeignKey(db_column='fk_profileid', on_delete=django.db.models.deletion.DO_NOTHING, related_name='registers', to='backend.Profile')),
        ...
        migrations.AddField(
            model_name='coursetypehole',
            name='hole_pk_holeid',
            field=models.ForeignKey(db_column='hole_pk_holeid', on_delete=django.db.models.deletion.DO_NOTHING, to='backend.Hole'),
        ),
        migrations.AddField(
